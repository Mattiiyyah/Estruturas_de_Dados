...
public class Lab_02_ProjetosJava_V4_APOS_AULA_Main {
	...
	public static void main(String[] args) throws Exception {
		...
		//instanciaçao de um obejto da classe '...Cordenador'
		Lab_02_ProjetosJava_V4_APOS_AULA_Coordenador coord = new Lab_02_ProjetosJava_V4_APOS_AULA_Coordenador();
		
		//adicionando o métdo 'de entrada' do objeto
		coord.executaTudo();
	}
