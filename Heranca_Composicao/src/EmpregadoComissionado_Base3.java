...
public class EmpregadoComissionado_Base3 extends Object
{
   ...
   // AQUI...
   private DiaMesAno dataNascimento; // data de nascimento, COMPOSIÇÃO de "diaMesAno"
   ...
   {
      this.dataNascimento = dataNascimento; // deve validar
   ...
   {                                                                
      return String.format( "%s: %s %s\n%s: %s\n%s: %s\n%s: %.2f\n%s: %.2f",
         ...
         "CPF", cpf, 
         "Data Nascimetno", dataNascimento,           
