...
public class TestesArrayAlunos {
    ...
    public void realizaTestes(Scanner teclado) {
        ...
        // Ação 1
        // Criar um array unidimensional de Aluno, em que cada elemento é um objeto da
        // classe Aluno.
        // O array deve permitir o armazenamento de dados de 4 alunos.
        Aluno[] alunos = new Aluno[4];

        // Ação 2
        // Preencher o conteúdo do array a partir de dados obtidos via teclado, um aluno
        // por vez.
        ...
        for(int i = 0; i < alunos.length; i++) {
            ...
            System.out.println("\n====================================");
            System.out.println("  Cadastro do " + (i+1) + "° Aluno");
            System.out.println("====================================");
            ...
            //Instanciando o obejto Aluno, transferindo os dados para o construtor
        ...
        System.out.println("\n====================================");
        System.out.println("  Exibindo Alunos (for + getters)");
        System.out.println("====================================");
        for(int i = 0; i < alunos.length; i++) {
            System.out.println("------------------------------------");
        ...
        // Ação 4
        // Por meio dos métodos 'setters' previstos na classe Aluno, alterar os
        // atributos de
        // um dos alunos cujos dados estão armazenados no array.
        alunos[2].setNome("Matheus de Paula");
        alunos[2].setRA("123456");
        alunos[2].setCurso("Info Manha");
